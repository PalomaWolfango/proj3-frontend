            ...
            <div className="container" style={{ border: '3px solid #00867d', padding: '50px 35px', marginTop: '90px', maxWidth: '500px' }}>
                <form /* onSubmit={(e) => createUser(e)} */>
                    ...
                    <div style={{textAlign: 'center', marginTop: '80px'}}>
                        <button type="submit" class="btn btn-info" style={{backgroundColor: '#00867d', border: '#00867d', color: 'white', padding: '5px 60px', float: 'left'}}>Create</button>
                    </div>
                    <div style={{textAlign: 'center', marginTop: '80px'}}>
                        <button type="submit" class="btn btn-danger" style={{color: 'white', padding: '5px 60px', float: 'right'}}>Delete</button>
                    </div>
                </form> 
            </div></>
        )
